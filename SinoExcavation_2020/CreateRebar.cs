                ...
                try
                {
                    ...
                    foreach (RebarBarType rebar_type in rebar_familyinstance)
                    {
                        if (rebar_type.Name == rebar_size_r)
                        {
                            ...
                            ver_r_diameter = rebar_type.get_Parameter(BuiltInParameter.REBAR_BAR_DIAMETER).AsDouble();
                    ...
                    foreach (RebarBarType rebar_type in rebar_familyinstance)
                    {
                        ...
                        {
                            ver_e_diameter = rebar_type.get_Parameter(BuiltInParameter.REBAR_BAR_DIAMETER).AsDouble();
                    ...
                    foreach (RebarBarType rebar_type in rebar_familyinstance)
                    {
                        ...
                        {
                            hor_diameter = rebar_type.get_Parameter(BuiltInParameter.REBAR_BAR_DIAMETER).AsDouble();
                        ...
                        for (int j = 0; j < dex.vertical_r_rebar.Count(); j++)
                        {
                            ...
                            if (rebar_type.Name == extra_r)
                            {
                                ...
                                ver_r_extra_diameter = rebar_type.get_Parameter(BuiltInParameter.REBAR_BAR_DIAMETER).AsDouble();
                        ...
                        for (int j = 0; j < dex.vertical_e_rebar.Count(); j++)
                        {
                            ...
                            if (rebar_type.Name == extra_e)
                            {
                                ...
                                ver_e_extra_diameter = rebar_type.get_Parameter(BuiltInParameter.REBAR_BAR_DIAMETER).AsDouble();
                    ...
                    { 
                        ...
                        foreach (RebarBarType rebar_type in rebar_familyinstance)
                        {
                            if (rebar_type.Name == h_rebar)
                            {
                                ...
                                {
                                    double h_diameter = rebar_type.get_Parameter(BuiltInParameter.REBAR_BAR_DIAMETER).AsDouble();
                                    //水平段數量
                                    ...
                                    for (int i = 0; i < number_h; i++)
                                    {
                                        ...
                                        // add start.Y
                                        XYZ rebarLineEnd = new XYZ(origin.X, start.Y - width/2 + pro - ver_e_diameter / 2 - h_diameter, origin.Z);
                    ...
                    foreach (RebarBarType rebar_type in rebar_familyinstance)
                    {
                        ...
                        {
                            ver_t_diameter = rebar_type.get_Parameter(BuiltInParameter.REBAR_BAR_DIAMETER).AsDouble();
